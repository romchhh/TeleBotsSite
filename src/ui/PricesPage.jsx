...
function PricesPage() {
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="p-6 flex-grow mt-20">
        ...
        <p className="text-lg text-left text-gray-700 mb-4 rounded-lg">
          Кожний бот є унікальним кейсом, що створений вирішувати проблему, чи розв'язувати питання
        ...
        <p className="text-lg text-left text-gray-700 rounded-lg">
      ...
      {/* Price Plans Section */}
      <div className="p-6 flex-grow mt-10">
        <h1 className="text-5xl font-extrabold mb-10 text-center text-gray-800 hover:text-gray-600 transition-colors duration-300 rounded-lg">
          Вартість розробки Telegram ботів
        </h1>

        <div className="container grid xl:grid-cols-3 gap-10 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 justify-items-center content-center">
          {PRICE_PLANS.map((plan, index) => (
            <div
              className="price-item p-6 border rounded-2xl shadow-lg text-center transition-transform transform hover:scale-105 hover:shadow-2xl"
              key={index}
            >
              ...
              <a href={plan.orderLink} target="_blank" rel="noopener noreferrer">
                <Button className="bg-blue-500 text-white px-4 py-2 rounded-full mb-6 hover:bg-blue-600 transition-colors">
                  {plan.orderText}
                </Button>
              </a>
  ...
  <Accordion>
    {FAQS.map((faq, index) => (
      ...
      <div className="bg-blue-50 p-10 mt-16 text-center rounded-2xl shadow-xl">
        <h3 className="text-3xl font-extrabold text-black-700 mb-6">Головне в дрібницях</h3>
      ...
      <div className="bg-gray-50 p-10 mt-16 text-center rounded-2xl shadow-xl">
        <h3 className="text-3xl font-extrabold text-black-700 mb-6">Зв'яжіться з нами</h3>
