        ...
        <div className='w-full flex md:justify-end justify-center items-center'>
          ...
          >
            ...
            <p className='font-bold text-xl'>
              TeleBots - це молода але досвідчена команда розробників, що спеціалізується на створенні сучасних цифрових рішень для бізнесу.
            </p>
            <p className='text-lg font-semibold'>
              Ми створюємо:<br />
              • Сучасні веб-сайти - від лендінгів до складних веб-платформ<br />
              • Інтернет-магазини з інтеграцією платіжних систем<br />
              • Телеграм-боти для автоматизації продажів та підтримки<br />
              • Чат-боти для швидкої обробки заявок<br />
              • Парсери для збору даних<br />
              • Автоворонки для автоматизації продажів<br />
            </p>
            <p className='text-lg font-semibold'>
            ...
            <p className='text-lg font-semibold'>
              Ми на зв'язку 24/7, тому залишайте вашу заявку в формі, або пишіть нам на телеграм і ми безкоштовно проконсультуємо вас!
            </p>
