        ...
        <footer className="bg-gradient-to-r from-black via-gray-900 to-black text-gray-300 py-8 mt-10">
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-4 md:px-0">
                ...
                <div className="mb-6 md:mb-0 text-center md:text-left">
                    ...
                    <p className="text-gray-500 mt-2">Ваш партнер у світі чат-ботів</p>
                </div>

                {/* Navigation Links */}
                <div className="flex flex-col md:flex-row md:space-x-8 text-center md:text-left mb-6 md:mb-0">
                    <a href="https://telebots.site/#" className="hover:text-gray-400 transition-colors">Головна</a>
                    <a href="https://telebots.site/prices" className="hover:text-gray-400 transition-colors">Ціни</a>
                    <a href="https://telebots.site/blog" className="hover:text-gray-400 transition-colors">Блог</a>
                </div>
            ...
            <div className="text-center mt-8">
                <p className="text-gray-600 text-sm">©2025 TeleBots. All rights reserved.</p>
            </div>
        </footer>
    );
}
