	...
	const works = [
		{
			...
			alt: 'Зображення сервісу для входу/в\'їзду в житловий комплекс'
		},
		...
		
		{
			...
			alt: 'Телеграм бот косметика'
		},
		{
			title: 'Бот для управління арбітражем трафіку в телеграм',
			description: `
		...
		{
			title: 'Телеграм бот для Суши-бару',
			description: `
		...
		{
			title: 'Sale Nice Device Bot - бот для перегляду техніки за фільтрами з можливістю додати своє оголошення',
			description: `
		...
		},
		{
			...
			alt: 'Телеграм бот обробник відео'
		},
		{
