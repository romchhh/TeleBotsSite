...
const BlogPost12 = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <Helmet> 
      <title>Налаштування бота для збору лідів та збільшення конверсії</title>
      <meta name="description" content="Дізнайтеся, як налаштувати Telegram бота для ефективного збору лідів та збільшення конверсії, щоб підвищити продажі та задоволеність клієнтів." />
      <meta name="keywords" content="Telegram боти, збору лідів, збільшення конверсії, автоматизація, персоналізовані рекомендації" />
      </Helmet>
